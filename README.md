...
!\[Benchmark Comparison](assets/benchmark\_healing.png)
...
!\[Meta-Nerve X-Ray](assets/meta\_nerve\_heatmap.png)
...
We provide the V6 implementation in `mycelium\_core.py`. This script demonstrates the Stone-Sand dynamics and the local uncertainty-based plasticity.



```bash

python mycelium\_core.py
